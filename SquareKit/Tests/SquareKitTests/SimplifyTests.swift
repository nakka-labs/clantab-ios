...
struct SimplifyTests {
    ...
    func testFullyCancellingTriangleCollapses() {
        ...
        let balances = [
            Balance(memberId: "A", netMinor: 0),
            Balance(memberId: "B", netMinor: 0),
            Balance(memberId: "C", netMinor: 0),
        ]
    ...
    func testImbalancedTriangleCollapses() {
        ...
        let balances = [
            Balance(memberId: "A", netMinor: -20),
            Balance(memberId: "B", netMinor: 10),
            Balance(memberId: "C", netMinor: 10),
        ]
        let result = Simplify.simplify(balances: balances)
    ...
    func testSinglePayerSimplifiesToDirectPayments() {
        ...
        let balances = [
            Balance(memberId: "payer", netMinor: 300),
            Balance(memberId: "m1", netMinor: -100),
            Balance(memberId: "m2", netMinor: -100),
            Balance(memberId: "m3", netMinor: -100),
        ]
        let result = Simplify.simplify(balances: balances)
