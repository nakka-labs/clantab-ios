...
final class CrossGroupSummaryTests: XCTestCase {
    ...
    func testSummaryYouOwe() {
        let s = CrossGroupSummary.line([net("INR", 120_000)], name: "Bob")
